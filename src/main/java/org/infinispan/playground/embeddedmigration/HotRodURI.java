...
public class HotRodURI {
      ...
      if (uri.getQuery() != null) {
         ...
         for (String part : parts) {
            ...
            if (eq < 0) {
               ...
               properties.setProperty("infinispan.client.hotrod." + part.substring(0, eq), part.substring(eq + 1));
            }
         }
      }
   ...
   public ConfigurationBuilder toConfigurationBuilder() {
      ...
      if (username != null && password != null) {
         builder.security().authentication().callbackHandler(new BasicCallbackHandler(username, password.toCharArray()));
      }
